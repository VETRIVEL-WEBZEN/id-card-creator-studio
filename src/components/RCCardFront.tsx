...
const RCCardFront = ({ data }: RCCardFrontProps) => {
  return (
    ...
    >
      ...
      <div className="absolute text-[8px] font-bold text-foreground" style={{ top: "50px", left: "90px" }}>
        {data.regnNo}
      </div>
      
      {/* Date of Regn - below "Date of Regn." label */}
      <div className="absolute text-[8px] font-bold text-foreground" style={{ top: "50px", left: "176px" }}>
        {data.dateOfRegn}
      </div>
      
      {/* Regn. Validity - below "Regn. Validity" label */}
      <div className="absolute text-[8px] font-bold text-foreground" style={{ top: "50px", left: "258px" }}>
        {data.regnValidity}
      </div>
